...
import { DollarSign, Calendar, CheckCircle2, Info, Edit, Trash2, MoreVertical } from "lucide-react";
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 pl-6">
            {dodItems.map((item, index) => (
              <li key={index} className="flex items-start gap-2 text-sm text-textNc">
