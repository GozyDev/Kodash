            ...
            <div className='flex justify-center gap-4  py-10'>
                <div className='flex bg-cardC/70 border border-cardCB rounded-full gap-4'>
                    <button
                        ...
                        className={`text-textNb rounded-full p-3 transition-all duration-300 ease-out transform active:scale-95 ${isClient ? 'bg-cardICB/50 shadow-sm' : 'bg-transparent hover:bg-cardC/70'} cursor-pointer`}
                    >
                        Paying For Service
                    </button>
                    <button
                        onClick={handleFreelancerView}
                        className={`text-textNb rounded-full p-3 transition-all duration-300 ease-out transform active:scale-95 ${isFreelancer ? 'bg-cardICB/50 shadow-sm' : 'bg-transparent hover:bg-cardC/70'} cursor-pointer`}
                    >
                        Providing A Service
                    </button>
                </div>
