...
export default function OrgHeader({
  ...
  return (
    <header className="fixed top-0 left-0 w-full flex justify-between items-center  text-neutral-100 px-2 py-3 border-b border-cardCB/80 bg-bgPrimary/90 backdrop-blur-2xl z-[999]">
